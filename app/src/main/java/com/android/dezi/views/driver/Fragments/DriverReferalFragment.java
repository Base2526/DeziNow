 ...
 */
public class DriverReferalFragment extends Fragment {
    Context mContext;
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_driver_referal,container,false);
        mContext = getActivity();
        ((BaseActivity)mContext).mTitle.setText("REFERRAL");
