 ...
 */
public class DriverFaqFragment extends Fragment {
    Context mContext;
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.activity_driver_faq, container, false);
        mContext = getActivity();
        ((BaseActivity)mContext).mTitle.setText("FAQS");
