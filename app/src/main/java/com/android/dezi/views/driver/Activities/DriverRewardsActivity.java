...
import com.android.dezi.views.driver.Fragments.DriverRewardFragment;

/**
 * Created by anuj.sharma on 5/12/2016.
 */
public class DriverRewardsActivity extends BaseActivity {
    Context mContext;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mContext = DriverRewardsActivity.this;
        modifyTolbar();
        navigateTo(new DriverRewardFragment());
    }
